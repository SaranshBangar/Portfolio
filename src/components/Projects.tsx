...
const Projects = () => {
  ...
  const imageUrl1 = "/trie.png";
  const imageUrl2 = "/gfg.png";
  const imageUrl3 = "/car_image.jpg";
  const imageUrl4 = "/forum_image.jpg";
  return (
    <section className="-mt-16 max-sm:-mt-12 w-[52%]">
        <div className="relative flex items-center justify-evenly flex-wrap mb-6 gap-5">
            ...
            <a href="https://github.com/SaranshBangar/GeeksforGeeks-Solutions" target="_blank">
              <DirectionAwareHover imageUrl={imageUrl2}>
                <p className="font-bold text-xl">
                  <a href="https://github.com/SaranshBangar/GeeksforGeeks-Solutions" target="_blank">
                    GFG Solutions - C++
